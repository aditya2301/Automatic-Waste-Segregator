...
if __name__ == "__main__" :
    try:
        stop_flag=Value('i',0)
        t1=Process(target=binStatus,args=(stop_flag,))
        t2=Process(target=imageProcessing,args=(stop_flag,))
        t1.start()
        t2.start()
        print("Started both the process succesfully !")
